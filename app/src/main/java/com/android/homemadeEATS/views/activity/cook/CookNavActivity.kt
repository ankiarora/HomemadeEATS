package com.android.homemadeEATS.views.activity.cook
...
class CookNavActivity : MainActivity() {
    lateinit var bottomNavigationView: BottomNavigationView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cook_nav)
        try {
...
//                R.id.menu_item_3 -> setCurrentFragment(CookPreparedOrdersFragment())
    ...
    companion object {
        private const val TAG = "CookNavActivity"
    }
}